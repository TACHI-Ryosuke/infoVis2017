function main(){
    ...
    //生成したインスタンスのverticesプロパティ(配列)に頂点座標を追加
    ...
    geometry.faces[2].color = new THREE.Color( 0.5, 0, 0);
    geometry.faces[3].color = new THREE.Color( 0.5, 0, 0 );
    geometry.faces[4].color = new THREE.Color( 0, 1, 0  );
    geometry.faces[5].color = new THREE.Color( 0, 1, 0 );
    geometry.faces[6].color = new THREE.Color( 0, 0.5, 0  );
    ...
    geometry.faces[10].color = new THREE.Color( 0, 0, 0.5 );
    geometry.faces[11].color = new THREE.Color( 0, 0, 0.5 );
